	...
	$(function(){
	    $('#larry-nav-side').click(function(){
	    	if($(this).attr('lay-filter')!== undefined){
	    		...
	    		console.log("li-length----"+$ul.find('li').length);
	    		console.log("li-eachtime----"+ new Date().getTime());
	...
	methods: {
		getMenuList: function () {
			$.getJSON("sys/menu/nav?_"+$.now(), function(r){
	    		...
	    		console.log("getmunutime----"+ new Date().getTime());
			});
		},
		getUser: function(){
			$.getJSON("sys/user/info?_"+$.now(), function(r){
				vm.user = r.user;
	    		console.log("getusertime----"+ new Date().getTime());
			});
		},
        ...
        donate: function () {
            layer.open({
                ...
                closeBtn: 1,
                shadeClose: false,
                content: ['https://avatars0.githubusercontent.com/u/5829870?s=460&v=4', 'no']
            });
        }
	},
	created: function(){
